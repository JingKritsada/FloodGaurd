...
export default function AppNavBar() {
	...
	return (
		...
		>
			<div className="glass pointer-events-auto flex w-fit max-w-lg items-center justify-around gap-1.5 overflow-visible rounded-3xl border border-slate-200 p-1.5 shadow-2xl dark:border-slate-700">
				{currentRole === "CITIZEN" && (
					<>
						<NavButton
							destination="/"
